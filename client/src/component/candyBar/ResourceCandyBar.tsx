...
const ResourceCandyBar: React.FC<Props> = (props) => {
  ...
  return (
    <>
      <Transition
        show={!showEdit}
        enter="transition delay-200 ease-out duration-200"
      ...
      >
        {(ref) => (
          <div
            ...
            className="candyBarWrapper flex flex-row flex-shrink h-10 w-full rounded-sm mt-1 mr-0 mb-1 ml-0"
          >
            <div className="flex items-center justify-between h-full w-full pr-0.5">
              <div data-testid="CandyBarInfo"
                   className="candyBarInfo flex h-10 m-0.5 items-center min-w-0 rounded-sm flex-grow">
                <a
                  className="candyBarTargetLink  flex min-w-0 rounded-sm items-center h-9"
      ...
      >
        {(ref) => (
          <div id={"editResourceForm"} className="rounded-sm editResource w-full mb-3 mt-3 p-1">
